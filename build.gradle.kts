...
dependencies {
    ...
    accessibilityTestImplementation("org.apache.commons:commons-compress:1.27.0")
    accessibilityTestImplementation("org.seleniumhq.selenium:selenium-java:4.23.1")
